...
#define RESTRICTED_SPECIES   list(SPECIES_ALIEN, SPECIES_GOLEM, SPECIES_DIONA, SPECIES_IPC, SPECIES_YEOSA, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_GRAVWORLDER, SPECIES_PSYKER, SPECIES_ASTARTES, SPECIES_ELDAR)
